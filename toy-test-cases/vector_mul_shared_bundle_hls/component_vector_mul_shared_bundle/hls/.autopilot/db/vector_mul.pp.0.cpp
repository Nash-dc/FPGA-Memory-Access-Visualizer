...
__attribute__((sdx_kernel("vector_mul", 0))) void vector_mul(const int in1[VECTOR_SIZE], const int in2[VECTOR_SIZE],
                int out[VECTOR_SIZE]);
# 2 "vector_mul.cpp" 2

__attribute__((sdx_kernel("vector_mul", 0))) void vector_mul(const int in1[VECTOR_SIZE], const int in2[VECTOR_SIZE],
                int out[VECTOR_SIZE]) {
#line 10 "/data/hls-dev/toy-test-cases/vector_mul_shared_bundle_hls/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=vector_mul
# 4 "vector_mul.cpp"
