...
# 2 "<built-in>" 2
# 1 "merge_sort_offchip.cpp" 2
# 1 "./merge_sort_offchip.h" 1



static const int SORT_SIZE = 64;

__attribute__((sdx_kernel("merge_sort_offchip_hls", 0))) void merge_sort_offchip_hls(const int in[SORT_SIZE], int scratch_a[SORT_SIZE],
                            int scratch_b[SORT_SIZE], int out[SORT_SIZE]);
# 2 "merge_sort_offchip.cpp" 2
...
__attribute__((sdx_kernel("merge_sort_offchip_hls", 0))) void merge_sort_offchip_hls(const int in[SORT_SIZE], int scratch_a[SORT_SIZE],
                            int scratch_b[SORT_SIZE], int out[SORT_SIZE]) {
#line 11 "/data/hls-dev/toy-test-cases/merge_sort_offchip_hls/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=merge_sort_offchip_hls
# 9 "merge_sort_offchip.cpp"
