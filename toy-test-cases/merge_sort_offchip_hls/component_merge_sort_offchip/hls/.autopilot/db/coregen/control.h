...
#define CONTROL_ADDR_SCRATCH_A_DATA 0x1c
#define CONTROL_BITS_SCRATCH_A_DATA 64
#define CONTROL_ADDR_SCRATCH_B_DATA 0x28
#define CONTROL_BITS_SCRATCH_B_DATA 64
