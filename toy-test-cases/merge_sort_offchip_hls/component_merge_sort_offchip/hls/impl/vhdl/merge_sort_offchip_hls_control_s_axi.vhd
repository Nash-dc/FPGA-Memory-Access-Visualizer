...
entity merge_sort_offchip_hls_control_s_axi is
generic (
...
end entity merge_sort_offchip_hls_control_s_axi;
...
architecture behave of merge_sort_offchip_hls_control_s_axi is
    ...
    constant ADDR_SCRATCH_A_DATA_0 : INTEGER := 16#1c#;
    constant ADDR_SCRATCH_A_DATA_1 : INTEGER := 16#20#;
    constant ADDR_SCRATCH_A_CTRL   : INTEGER := 16#24#;
    constant ADDR_SCRATCH_B_DATA_0 : INTEGER := 16#28#;
    constant ADDR_SCRATCH_B_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_SCRATCH_B_CTRL   : INTEGER := 16#30#;
