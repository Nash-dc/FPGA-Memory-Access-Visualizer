...
//
//==============================================================
`ifndef READ_WRITE_SCOREBOARD__SV                                                       
    `define READ_WRITE_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class read_write_scoreboard extends uvm_component;                                        
                                                                                               
        read_write_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(read_write_scoreboard)                                     
                ...
                forever begin                                                                  
                    ...
                    for(int j=0; j<refm.ap_done_cnt; j++) begin
                        if(j<refm.trans_num_total) begin
                            refm.mem_blk_pages_mem_0.tvout_dump_frontpage(1);
                        end
                    end
                    for(int j=0; j<refm.ap_done_cnt; j++) begin
                        if(j<refm.trans_num_total) begin
                            refm.mem_blk_pages_mem_1.tvout_dump_frontpage(1);
                        end
                    end
                end                                                                            
                begin                                                                          
