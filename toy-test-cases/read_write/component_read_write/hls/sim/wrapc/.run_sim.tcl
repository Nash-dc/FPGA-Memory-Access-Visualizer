...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "read_write.autotvin.dat"
	set constFileTvOut       "read_write.autotvout.dat"
	set constFileHdlTvIn     "read_write.autohdltvin.dat"
	set constFileHdlTvOut    "read_write.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
