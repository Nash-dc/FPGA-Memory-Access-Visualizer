set SynModuleInfo {
  ...
  {SRCNAME read_write MODELNAME read_write RTLNAME read_write IS_TOP 1
    SUBMODULES {
      {MODELNAME read_write_fifo_w32_d128_A RTLNAME read_write_fifo_w32_d128_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME stream_U}
      ...
      {MODELNAME read_write_fifo_w32_d128_A RTLNAME read_write_fifo_w32_d128_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME stream_1_U}
