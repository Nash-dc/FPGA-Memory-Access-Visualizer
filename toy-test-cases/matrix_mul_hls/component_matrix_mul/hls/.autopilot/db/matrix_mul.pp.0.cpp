...
__attribute__((sdx_kernel("matrix_mul", 0))) void matrix_mul(const int a[MATRIX_SIZE], const int b[MATRIX_SIZE],
                int c[MATRIX_SIZE]);
# 2 "matrix_mul.cpp" 2

__attribute__((sdx_kernel("matrix_mul", 0))) void matrix_mul(const int a[MATRIX_SIZE],
                const int b[MATRIX_SIZE],
                int c[MATRIX_SIZE]) {
#line 11 "/data/hls-dev/toy-test-cases/matrix_mul_hls/run_hls.tcl"
