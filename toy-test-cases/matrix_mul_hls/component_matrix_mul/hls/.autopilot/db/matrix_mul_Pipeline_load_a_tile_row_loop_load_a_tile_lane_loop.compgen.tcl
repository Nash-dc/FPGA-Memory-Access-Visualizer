...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A_tile \
    op interface \
    ports { A_tile_address0 { O 4 vector } A_tile_ce0 { O 1 bit } A_tile_we0 { O 1 bit } A_tile_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'A_tile'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A_tile_1 \
    op interface \
    ports { A_tile_1_address0 { O 4 vector } A_tile_1_ce0 { O 1 bit } A_tile_1_we0 { O 1 bit } A_tile_1_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'A_tile_1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A_tile_2 \
    op interface \
    ports { A_tile_2_address0 { O 4 vector } A_tile_2_ce0 { O 1 bit } A_tile_2_we0 { O 1 bit } A_tile_2_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'A_tile_2'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A_tile_3 \
    op interface \
    ports { A_tile_3_address0 { O 4 vector } A_tile_3_ce0 { O 1 bit } A_tile_3_we0 { O 1 bit } A_tile_3_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'A_tile_3'"
}
}
