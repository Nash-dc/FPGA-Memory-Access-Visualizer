...
extern "C" void matrix_mul(Byte<16>*, Byte<64>*, Byte<64>*, int, int, int);
extern "C" void apatb_matrix_mul_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c) {
...
__xlx_c__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_c)[i]);
  ...
  // DUT call
  matrix_mul(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_c__tmp_vec.data(), __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_c);
