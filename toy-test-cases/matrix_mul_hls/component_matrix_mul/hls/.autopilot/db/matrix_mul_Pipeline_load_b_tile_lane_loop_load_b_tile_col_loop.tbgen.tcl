set moduleName matrix_mul_Pipeline_load_b_tile_lane_loop_load_b_tile_col_loop
set isTopModule 0
...
set cdfgNum 8
set C_modelName {matrix_mul_Pipeline_load_b_tile_lane_loop_load_b_tile_col_loop}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict B_tile_3 { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict B_tile_2 { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict B_tile_1 { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict B_tile { MEM_WIDTH 32 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem_b int 512 regular {axi_master 0}  }
	{ B_tile_3 int 32 regular {array 16 { 0 3 } 0 1 }  }
	{ B_tile_2 int 32 regular {array 16 { 0 3 } 0 1 }  }
	{ B_tile_1 int 32 regular {array 16 { 0 3 } 0 1 }  }
	{ B_tile int 32 regular {array 16 { 0 3 } 0 1 }  }
	{ sext_ln36 int 58 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_b", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "b","offset": { "type": "dynamic","port_name": "b","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "B_tile_3", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "B_tile_2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "B_tile_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "B_tile", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sext_ln36", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ B_tile_3_address0 sc_out sc_lv 4 signal 1 } 
	{ B_tile_3_ce0 sc_out sc_logic 1 signal 1 } 
	{ B_tile_3_we0 sc_out sc_logic 1 signal 1 } 
	{ B_tile_3_d0 sc_out sc_lv 32 signal 1 } 
	{ B_tile_2_address0 sc_out sc_lv 4 signal 2 } 
	{ B_tile_2_ce0 sc_out sc_logic 1 signal 2 } 
	{ B_tile_2_we0 sc_out sc_logic 1 signal 2 } 
	{ B_tile_2_d0 sc_out sc_lv 32 signal 2 } 
	{ B_tile_1_address0 sc_out sc_lv 4 signal 3 } 
	{ B_tile_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ B_tile_1_we0 sc_out sc_logic 1 signal 3 } 
	{ B_tile_1_d0 sc_out sc_lv 32 signal 3 } 
	{ B_tile_address0 sc_out sc_lv 4 signal 4 } 
	{ B_tile_ce0 sc_out sc_logic 1 signal 4 } 
	{ B_tile_we0 sc_out sc_logic 1 signal 4 } 
	{ B_tile_d0 sc_out sc_lv 32 signal 4 } 
	{ sext_ln36 sc_in sc_lv 58 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "B_tile_3_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "B_tile_3", "role": "we0" }} , 
 	{ "name": "B_tile_3_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "B_tile_3", "role": "d0" }} , 
 	...
 	{ "name": "B_tile_2_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "B_tile_2", "role": "we0" }} , 
 	{ "name": "B_tile_2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "B_tile_2", "role": "d0" }} , 
 	...
 	{ "name": "B_tile_1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "B_tile_1", "role": "we0" }} , 
 	{ "name": "B_tile_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "B_tile_1", "role": "d0" }} , 
 	...
 	{ "name": "B_tile_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "B_tile", "role": "we0" }} , 
 	{ "name": "B_tile_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "B_tile", "role": "d0" }} , 
 	{ "name": "sext_ln36", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln36", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	B_tile_3 { ap_memory {  { B_tile_3_address0 mem_address 1 4 }  { B_tile_3_ce0 mem_ce 1 1 }  { B_tile_3_we0 mem_we 1 1 }  { B_tile_3_d0 mem_din 1 32 } } }
	B_tile_2 { ap_memory {  { B_tile_2_address0 mem_address 1 4 }  { B_tile_2_ce0 mem_ce 1 1 }  { B_tile_2_we0 mem_we 1 1 }  { B_tile_2_d0 mem_din 1 32 } } }
	B_tile_1 { ap_memory {  { B_tile_1_address0 mem_address 1 4 }  { B_tile_1_ce0 mem_ce 1 1 }  { B_tile_1_we0 mem_we 1 1 }  { B_tile_1_d0 mem_din 1 32 } } }
	B_tile { ap_memory {  { B_tile_address0 mem_address 1 4 }  { B_tile_ce0 mem_ce 1 1 }  { B_tile_we0 mem_we 1 1 }  { B_tile_d0 mem_din 1 32 } } }
	sext_ln36 { ap_none {  { sext_ln36 in_data 0 58 } } }
}
