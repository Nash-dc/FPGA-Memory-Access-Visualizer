...
# 2 "<built-in>" 2
# 1 "matmul_row_col.cpp" 2
# 1 "./matmul_row_col.h" 1
...
__attribute__((sdx_kernel("matmul_row_col", 0))) void matmul_row_col(const int a[MATRIX_SIZE], const int b[MATRIX_SIZE],
                    int c[OUTPUT_SIZE]);
# 2 "matmul_row_col.cpp" 2

__attribute__((sdx_kernel("matmul_row_col", 0))) void matmul_row_col(const int a[MATRIX_SIZE], const int b[MATRIX_SIZE],
                    int c[OUTPUT_SIZE]) {
#line 11 "/data/hls-dev/toy-test-cases/matrix_mul_row_col_hls/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=matmul_row_col
# 4 "matmul_row_col.cpp"
