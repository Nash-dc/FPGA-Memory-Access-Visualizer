...
set cdfgNum 5
set C_modelName {matmul_row_col}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_a", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "a","offset": { "type": "dynamic","port_name": "a","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "gmem_c", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "c","offset": { "type": "dynamic","port_name": "c","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"matmul_row_col","role":"start","value":"0","valid_bit":"0"},{"name":"matmul_row_col","role":"continue","value":"0","valid_bit":"4"},{"name":"matmul_row_col","role":"auto_start","value":"0","valid_bit":"7"},{"name":"a","role":"data","value":"16"},{"name":"b","role":"data","value":"28"},{"name":"c","role":"data","value":"40"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"matmul_row_col","role":"start","value":"0","valid_bit":"0"},{"name":"matmul_row_col","role":"done","value":"0","valid_bit":"1"},{"name":"matmul_row_col","role":"idle","value":"0","valid_bit":"2"},{"name":"matmul_row_col","role":"ready","value":"0","valid_bit":"3"},{"name":"matmul_row_col","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set ArgLastReadFirstWriteLatency {
	matmul_row_col {
		gmem_a {Type I LastRead 11 FirstWrite -1}
		gmem_b {Type I LastRead 13 FirstWrite -1}
		gmem_c {Type O LastRead 3 FirstWrite 25}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "13751", "Max" : "13751"}
	, {"Name" : "Interval", "Min" : "13752", "Max" : "13752"}
]}
