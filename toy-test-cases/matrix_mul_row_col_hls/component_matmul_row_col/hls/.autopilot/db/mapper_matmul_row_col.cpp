...
extern "C" void matmul_row_col(Byte<64>*, Byte<64>*, Byte<4>*, int, int, int);
extern "C" void apatb_matmul_row_col_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c) {
...
__xlx_c__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_c)[i]);
  ...
  // DUT call
  matmul_row_col(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_c__tmp_vec.data(), __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_c);
