...
# 1 "/data/2025.1/Vitis/common/technology/autopilot/hls_stream.h" 1
# 12 "/data/2025.1/Vitis/common/technology/autopilot/hls_stream.h"
# 1 "/data/2025.1/Vitis/common/technology/autopilot/hls_stream_39.h" 1
# 23 "/data/2025.1/Vitis/common/technology/autopilot/hls_stream_39.h"
namespace hls {
# 49 "/data/2025.1/Vitis/common/technology/autopilot/hls_stream_39.h"
...
# 13 "/data/2025.1/Vitis/common/technology/autopilot/hls_stream.h" 2
# 3 "./read_write.h" 2
...
extern "C" {
__attribute__((sdx_kernel("read_only", 0))) void read_only(
    int * mem_0,
    int * mem_1,
    int & res
    );
    ...
    )
{
  VITIS_LOOP_9_1: for(int i = 0; i < 8; i++){
    ...
    VITIS_LOOP_11_2: for(int j = 0; j < 128; j++){
...
{
  VITIS_LOOP_38_1: for(int i = 0; i < 128*8; i++){
...
#pragma HLS dataflow
 hls::stream<int,2> stream[2];
  ...
  read(mem_1,128,stream[1]);
  write(mem_0,128*8*2+0,stream[0]);
  write(mem_1,128*8*2+128,stream[1]);
}
...
{
#line 15 "/data/hls-dev/toy-test-cases/read_only/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=read_only
# 65 "read_write.cpp"
...
#pragma HLS dataflow
 hls::stream<int,2> stream[2];
  VITIS_LOOP_72_1: for(int i = 0; i < 128*8; i++){
#pragma HLS pipeline II=1
 stream[0].write(mem_0[i]);
  }
  VITIS_LOOP_76_2: for(int i = 0; i < 128*8; i++){
#pragma HLS pipeline II=1
 stream[1].write(mem_1[128*8 + i]);
  }
