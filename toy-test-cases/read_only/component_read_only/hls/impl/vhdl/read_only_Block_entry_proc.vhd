...
entity read_only_Block_entry_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of read_only_Block_entry_proc is 
...
attribute shreg_extract : string;
    ...
    signal add_ln76_fu_12_p2 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_preg <= add_ln76_fu_12_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    add_ln76_fu_12_p2 <= std_logic_vector(unsigned(mem_1_r) + unsigned(ap_const_lv64_1000));
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, add_ln76_fu_12_p2, ap_return_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= add_ln76_fu_12_p2;
        else 
