set moduleName merge_sort_hls_Pipeline_load_input_loop
set isTopModule 0
...
set cdfgNum 7
set C_modelName {merge_sort_hls_Pipeline_load_input_loop}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict buffer_a { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem_in int 512 regular {axi_master 0}  }
	{ buffer_a int 32 regular {array 64 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ sext_ln19 int 58 regular  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem_in", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "buffer_a", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sext_ln19", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ m_axi_gmem_in_0_WDATA sc_out sc_lv 512 signal 0 } 
	{ m_axi_gmem_in_0_WSTRB sc_out sc_lv 64 signal 0 } 
	...
	{ m_axi_gmem_in_0_RDATA sc_in sc_lv 512 signal 0 } 
	{ m_axi_gmem_in_0_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem_in_0_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_gmem_in_0_RFIFONUM sc_in sc_lv 9 signal 0 } 
	...
	{ buffer_a_address0 sc_out sc_lv 6 signal 1 } 
	{ buffer_a_ce0 sc_out sc_logic 1 signal 1 } 
	{ buffer_a_we0 sc_out sc_logic 1 signal 1 } 
	{ buffer_a_d0 sc_out sc_lv 32 signal 1 } 
	{ sext_ln19 sc_in sc_lv 58 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_gmem_in_0_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "gmem_in", "role": "0_WDATA" }} , 
 	{ "name": "m_axi_gmem_in_0_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "gmem_in", "role": "0_WSTRB" }} , 
 	...
 	{ "name": "m_axi_gmem_in_0_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "gmem_in", "role": "0_RDATA" }} , 
 	...
 	{ "name": "buffer_a_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buffer_a", "role": "we0" }} , 
 	{ "name": "buffer_a_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buffer_a", "role": "d0" }} , 
 	{ "name": "sext_ln19", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln19", "role": "default" }}  ]}

set ArgLastReadFirstWriteLatency {
	merge_sort_hls_Pipeline_load_input_loop {
		gmem_in {Type I LastRead 1 FirstWrite -1}
		buffer_a {Type O LastRead -1 FirstWrite 2}
...
set Spec2ImplPortList { 
	 { m_axi {  { m_axi_gmem_in_0_AWVALID VALID 1 1 }  { m_axi_gmem_in_0_AWREADY READY 0 1 }  { m_axi_gmem_in_0_AWADDR ADDR 1 64 }  { m_axi_gmem_in_0_AWID ID 1 1 }  { m_axi_gmem_in_0_AWLEN SIZE 1 32 }  { m_axi_gmem_in_0_AWSIZE BURST 1 3 }  { m_axi_gmem_in_0_AWBURST LOCK 1 2 }  { m_axi_gmem_in_0_AWLOCK CACHE 1 2 }  { m_axi_gmem_in_0_AWCACHE PROT 1 4 }  { m_axi_gmem_in_0_AWPROT QOS 1 3 }  { m_axi_gmem_in_0_AWQOS REGION 1 4 }  { m_axi_gmem_in_0_AWREGION USER 1 4 }  { m_axi_gmem_in_0_AWUSER DATA 1 1 }  { m_axi_gmem_in_0_WVALID VALID 1 1 }  { m_axi_gmem_in_0_WREADY READY 0 1 }  { m_axi_gmem_in_0_WDATA FIFONUM 1 512 }  { m_axi_gmem_in_0_WSTRB STRB 1 64 }  { m_axi_gmem_in_0_WLAST LAST 1 1 }  { m_axi_gmem_in_0_WID ID 1 1 }  { m_axi_gmem_in_0_WUSER DATA 1 1 }  { m_axi_gmem_in_0_ARVALID VALID 1 1 }  { m_axi_gmem_in_0_ARREADY READY 0 1 }  { m_axi_gmem_in_0_ARADDR ADDR 1 64 }  { m_axi_gmem_in_0_ARID ID 1 1 }  { m_axi_gmem_in_0_ARLEN SIZE 1 32 }  { m_axi_gmem_in_0_ARSIZE BURST 1 3 }  { m_axi_gmem_in_0_ARBURST LOCK 1 2 }  { m_axi_gmem_in_0_ARLOCK CACHE 1 2 }  { m_axi_gmem_in_0_ARCACHE PROT 1 4 }  { m_axi_gmem_in_0_ARPROT QOS 1 3 }  { m_axi_gmem_in_0_ARQOS REGION 1 4 }  { m_axi_gmem_in_0_ARREGION USER 1 4 }  { m_axi_gmem_in_0_ARUSER DATA 1 1 }  { m_axi_gmem_in_0_RVALID VALID 0 1 }  { m_axi_gmem_in_0_RREADY READY 1 1 }  { m_axi_gmem_in_0_RDATA FIFONUM 0 512 }  { m_axi_gmem_in_0_RLAST LAST 0 1 }  { m_axi_gmem_in_0_RID ID 0 1 }  { m_axi_gmem_in_0_RFIFONUM LEN 0 9 }  { m_axi_gmem_in_0_RUSER DATA 0 1 }  { m_axi_gmem_in_0_RRESP RESP 0 2 }  { m_axi_gmem_in_0_BVALID VALID 0 1 }  { m_axi_gmem_in_0_BREADY READY 1 1 }  { m_axi_gmem_in_0_BRESP RESP 0 2 }  { m_axi_gmem_in_0_BID ID 0 1 }  { m_axi_gmem_in_0_BUSER DATA 0 1 } } }
	buffer_a { ap_memory {  { buffer_a_address0 mem_address 1 6 }  { buffer_a_ce0 mem_ce 1 1 }  { buffer_a_we0 mem_we 1 1 }  { buffer_a_d0 mem_din 1 32 } } }
	sext_ln19 { ap_none {  { sext_ln19 in_data 0 58 } } }
}
