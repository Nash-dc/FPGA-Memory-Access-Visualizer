set moduleName merge_sort_hls_Pipeline_store_output_loop
set isTopModule 0
...
set cdfgNum 7
set C_modelName {merge_sort_hls_Pipeline_store_output_loop}
...
set C_modelArgList {
	...
	{ sext_ln70 int 58 regular  }
	{ buffer_a int 32 regular {array 64 { 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_out", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln70", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln70 sc_in sc_lv 58 signal 1 } 
	{ buffer_a_address0 sc_out sc_lv 6 signal 2 } 
	{ buffer_a_ce0 sc_out sc_logic 1 signal 2 } 
	{ buffer_a_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln70", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln70", "role": "default" }} , 
...
set ArgLastReadFirstWriteLatency {
	merge_sort_hls_Pipeline_store_output_loop {
...
set Spec2ImplPortList { 
	...
	sext_ln70 { ap_none {  { sext_ln70 in_data 0 58 } } }
	buffer_a { ap_memory {  { buffer_a_address0 mem_address 1 6 }  { buffer_a_ce0 mem_ce 1 1 }  { buffer_a_q0 mem_dout 0 32 } } }
}
