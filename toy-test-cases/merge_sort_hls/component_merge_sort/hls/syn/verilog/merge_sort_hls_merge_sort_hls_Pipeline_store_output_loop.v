...
module merge_sort_hls_merge_sort_hls_Pipeline_store_output_loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_idle_pp0;
reg   [0:0] icmp_ln72_reg_228;
reg   [0:0] icmp_ln72_reg_228_pp0_iter1_reg;
...
wire   [0:0] icmp_ln72_fu_139_p2;
reg   [31:0] buffer_a_load_reg_233;
wire   [63:0] zext_ln70_fu_130_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [479:0] phi_ln72_fu_66;
wire   [479:0] select_ln72_fu_187_p3;
wire    ap_loop_init;
reg   [6:0] i_fu_70;
wire   [6:0] add_ln70_fu_124_p2;
reg   [6:0] ap_sig_allocacmp_i_1;
reg    buffer_a_ce0_local;
wire   [3:0] trunc_ln70_fu_135_p1;
wire   [447:0] tmp_1_fu_170_p4;
wire   [479:0] tmp_2_fu_180_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln70_fu_118_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln70_fu_118_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_grp1) & (icmp_ln72_reg_228_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001_grp1) & (icmp_ln72_reg_228_pp0_iter1_reg == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
...
assign add_ln70_fu_124_p2 = (ap_sig_allocacmp_i_1 + 7'd1);
...
always @ (*) begin
    ap_block_state3_io_grp1 = ((icmp_ln72_reg_228_pp0_iter1_reg == 1'd1) & (m_axi_gmem_out_0_WREADY == 1'b0));
end
...
assign buffer_a_address0 = zext_ln70_fu_130_p1;

assign buffer_a_ce0 = buffer_a_ce0_local;

assign icmp_ln70_fu_118_p2 = ((ap_sig_allocacmp_i_1 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln72_fu_139_p2 = ((trunc_ln70_fu_135_p1 == 4'd15) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_out_0_WDATA = {{buffer_a_load_reg_233}, {phi_ln72_fu_66}};
...
assign select_ln72_fu_187_p3 = ((icmp_ln72_reg_228_pp0_iter1_reg[0:0] == 1'b1) ? 480'd0 : tmp_2_fu_180_p3);

assign tmp_1_fu_170_p4 = {{phi_ln72_fu_66[479:32]}};

assign tmp_2_fu_180_p3 = {{buffer_a_load_reg_233}, {tmp_1_fu_170_p4}};

assign trunc_ln70_fu_135_p1 = ap_sig_allocacmp_i_1[3:0];

assign zext_ln70_fu_130_p1 = ap_sig_allocacmp_i_1;

endmodule //merge_sort_hls_merge_sort_hls_Pipeline_store_output_loop
