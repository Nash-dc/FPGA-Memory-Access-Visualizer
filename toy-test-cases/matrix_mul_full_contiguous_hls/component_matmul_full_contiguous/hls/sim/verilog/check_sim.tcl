...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matmul_full_contiguous.autotvin_gmem_a.dat"
         "c.matmul_full_contiguous.autotvin_gmem_b.dat"
         "c.matmul_full_contiguous.autotvin_a.dat"
         "c.matmul_full_contiguous.autotvin_b.dat"
         "c.matmul_full_contiguous.autotvin_c.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matmul_full_contiguous.autotvout_gmem_c.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
