...
if {[file isfile matmul_full_contiguous.autotvin.dat]} {
	file delete -force matmul_full_contiguous.autotvin.dat
}

if {[file isfile matmul_full_contiguous.autotvout.dat]} {
	file delete -force matmul_full_contiguous.autotvout.dat
}
