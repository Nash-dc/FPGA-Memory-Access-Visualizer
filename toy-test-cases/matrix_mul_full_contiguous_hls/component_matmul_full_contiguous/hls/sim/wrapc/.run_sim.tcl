...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /data/2025.1/Vitis/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/2025.1/Vitis/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/2025.1/Vitis/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/2025.1/Vitis/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /data/2025.1/Vitis/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matmul_full_contiguous.autotvin.dat"
	set constFileTvOut       "matmul_full_contiguous.autotvout.dat"
	set constFileHdlTvIn     "matmul_full_contiguous.autohdltvin.dat"
	set constFileHdlTvOut    "matmul_full_contiguous.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
