...
AUTOPILOT_ROOT := /data/2025.1/Vitis
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /data/2025.1/Vitis/tps/lnx64/gcc-8.3.0/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := /data/2025.1/Vitis/lnx64/tools/vcxx/libexec/
TOOLCHAIN += --gcc-toolchain=/data/2025.1/Vitis/tps/lnx64/gcc-8.3.0
LFLAG += --gcc-toolchain=/data/2025.1/Vitis/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/matmul_full_contiguous_test.cpp_pre.cpp.tb.o : matmul_full_contiguous_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling matmul_full_contiguous_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/matmul_full_contiguous.cpp_pre.cpp.tb.o : matmul_full_contiguous.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling matmul_full_contiguous.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
