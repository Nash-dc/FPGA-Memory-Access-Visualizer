...
# 2 "<built-in>" 2
# 1 "matmul_full_contiguous.cpp" 2
# 1 "./matmul_full_contiguous.h" 1
...
__attribute__((sdx_kernel("matmul_full_contiguous", 0))) void matmul_full_contiguous(const int a[MATRIX_SIZE],
                            const int b[MATRIX_SIZE],
                            int c[MATRIX_SIZE]);
# 2 "matmul_full_contiguous.cpp" 2

__attribute__((sdx_kernel("matmul_full_contiguous", 0))) void matmul_full_contiguous(const int a[MATRIX_SIZE],
                            const int b[MATRIX_SIZE],
                            int c[MATRIX_SIZE]) {
#line 11 "/data/hls-dev/toy-test-cases/matrix_mul_full_contiguous_hls/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=matmul_full_contiguous
# 5 "matmul_full_contiguous.cpp"
