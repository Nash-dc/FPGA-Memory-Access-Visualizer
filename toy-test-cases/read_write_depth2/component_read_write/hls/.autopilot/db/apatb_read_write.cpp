...
#define AUTOTB_TVOUT_mem_0_r "../tv/cdatafile/c.read_write.autotvout_mem_0_r.dat"
#define AUTOTB_TVIN_mem_1_r "../tv/cdatafile/c.read_write.autotvin_mem_1_r.dat"
#define AUTOTB_TVOUT_mem_1_r "../tv/cdatafile/c.read_write.autotvout_mem_1_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_mem_0 "../tv/rtldatafile/rtl.read_write.autotvout_mem_0.dat"
#define AUTOTB_TVOUT_PC_mem_1 "../tv/rtldatafile/rtl.read_write.autotvout_mem_1.dat"
...
extern "C"
void read_write_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_read_write_hw(void* __xlx_apatb_param_mem_0_r, void* __xlx_apatb_param_mem_1_r)
{
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_mem_0),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_mem_0),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_mem_0),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_mem_0),
#endif
#ifdef USE_BINARY_TV_FILE
  ...
  port2.param = { __xlx_apatb_param_mem_0_r };
  port2.mname = { "mem_0_r" };
  port2.nbytes = { 16384 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_mem_1),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_mem_1),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_mem_1),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_mem_1),
#endif
#ifdef USE_BINARY_TV_FILE
  ...
  port3.param = { __xlx_apatb_param_mem_1_r };
  port3.mname = { "mem_1_r" };
  port3.nbytes = { 16384 };
  ...
  try {
    ...
    read_write_hw_stub_wrapper(__xlx_apatb_param_mem_0_r, __xlx_apatb_param_mem_1_r);
