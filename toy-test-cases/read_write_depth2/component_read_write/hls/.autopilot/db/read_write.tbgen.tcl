...
set cdfgNum 7
set C_modelName {read_write}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ mem_0 int 512 regular {axi_master 2}  }
	{ mem_1 int 512 regular {axi_master 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mem_0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "mem_0_r","offset": { "type": "dynamic","port_name": "mem_0_r","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "mem_1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "mem_1_r","offset": { "type": "dynamic","port_name": "mem_1_r","bundle": "control"},"direction": "READWRITE"}]}]} , 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"read_write","role":"start","value":"0","valid_bit":"0"},{"name":"read_write","role":"continue","value":"0","valid_bit":"4"},{"name":"read_write","role":"auto_start","value":"0","valid_bit":"7"},{"name":"mem_0_r","role":"data","value":"16"},{"name":"mem_1_r","role":"data","value":"28"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"read_write","role":"start","value":"0","valid_bit":"0"},{"name":"read_write","role":"done","value":"0","valid_bit":"1"},{"name":"read_write","role":"idle","value":"0","valid_bit":"2"},{"name":"read_write","role":"ready","value":"0","valid_bit":"3"},{"name":"read_write","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set ArgLastReadFirstWriteLatency {
	read_write {
		mem_0 {Type IO LastRead 73 FirstWrite -1}
		mem_1 {Type IO LastRead 73 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "32883", "Max" : "32883"}
	, {"Name" : "Interval", "Min" : "32768", "Max" : "32768"}
]}
...
dict set maxi_interface_dict mem_0 { CHANNEL_NUM 0 BUNDLE mem_0 NUM_READ_OUTSTANDING 1 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 READ_WRITE_MODE READ_WRITE}
dict set maxi_interface_dict mem_1 { CHANNEL_NUM 0 BUNDLE mem_1 NUM_READ_OUTSTANDING 1 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 READ_WRITE_MODE READ_WRITE}
