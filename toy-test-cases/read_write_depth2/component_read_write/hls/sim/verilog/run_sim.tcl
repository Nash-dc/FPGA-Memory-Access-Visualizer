...
if {[file isfile read_write.autotvin.dat]} {
	file delete -force read_write.autotvin.dat
}

if {[file isfile read_write.autotvout.dat]} {
	file delete -force read_write.autotvout.dat
}
