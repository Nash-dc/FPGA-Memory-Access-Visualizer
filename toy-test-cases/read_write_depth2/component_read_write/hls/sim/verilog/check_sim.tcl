...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.read_write.autotvin_mem_0.dat"
         "c.read_write.autotvin_mem_1.dat"
         "c.read_write.autotvin_mem_0_r.dat"
         "c.read_write.autotvin_mem_1_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.read_write.autotvout_mem_0.dat"
         "rtl.read_write.autotvout_mem_1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
